...
namespace MarcelJoachimKloubert.CLRToolbox.Net.Http
{
    ...
    /// </summary>
    public interface IHttpResponse : IObject
    {
        ...
        /// Adds data at the end of <see cref="IHttpResponse.Stream" />.
        /// </summary>
        /// <param name="str">The data to add.</param>
        /// <returns>That instance.</returns>
        IHttpResponse Append(string str);
        ...
        /// <param name="str">The data to add.</param>
        /// <returns>That instance.</returns>
        IHttpResponse Prefix(string str);
        ...
        /// </exception>
        IHttpResponse SetStream(Stream stream, bool disposeOld = false);
        ...
        IHttpResponse Write(string str);
        ...
        /// <returns>That instance.</returns>
        IHttpResponse Write(object obj, bool handleDBNullAsNull = true);
        ...
        /// <returns>That instance.</returns>
        IHttpResponse WriteJavaScript(string js);
