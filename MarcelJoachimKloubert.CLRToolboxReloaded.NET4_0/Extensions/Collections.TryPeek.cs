...
namespace MarcelJoachimKloubert.CLRToolbox.Extensions
{
    static partial class ClrToolboxExtensionMethods
    {
        ...
        /// <summary>
        /// Tries to peek an item on a stack.
        /// </summary>
        ...
        /// <returns>Peek operation was successfull or not.</returns>
        ...
        /// </exception>
        public static bool TryPeek<T>(this Stack<T> stack, out T value, Func<Stack<T>, T> defaultValueProvider)
        {
            if (stack == null)
            {
