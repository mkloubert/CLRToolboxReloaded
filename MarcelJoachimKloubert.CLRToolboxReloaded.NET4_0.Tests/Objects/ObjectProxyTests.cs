...
namespace MarcelJoachimKloubert.CLRToolbox._Tests.Objects
{
    /// <summary>
    /// Test object proxies.
    /// </summary>
    public class ObjectProxyTests : TestFixtureBase
    {
        #region INTERFACE: ITest1
