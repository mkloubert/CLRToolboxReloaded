...
namespace RestSharp.Authenticators.OAuth
{
    ...
    /// <seealso href="http://oauth.net/core/1.0#anchor9"/>
	/// </summary>
	internal class OAuthWorkflow
	{
		...
		/// </summary>
		/// <param name="method">The HTTP method for the intended request</param>
        /// <seealso href="http://tools.ietf.org/html/draft-dehora-farrell-oauth-accesstoken-creds-00#section-4"/>
		/// <param name="parameters">Any existing, non-OAuth query parameters desired in the request</param>
		...
		public virtual OAuthWebQueryInfo BuildProtectedResourceInfo(string method, WebParameterCollection parameters, string url)
		{
            ...
            var urlParameters = global::System.Web.HttpUtility.ParseQueryString(uri.Query);
#else
