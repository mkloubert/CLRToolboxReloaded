...
namespace MarcelJoachimKloubert.CLRToolbox.Windows.Data
{
    ...
    public class BooleanToVisibilityConverter : MultiParamValueConverterBase<bool?, Visibility?>
    {
        ...
        /// <inheriteddoc />
        protected override Visibility? OnConvert(bool? value, IList<string> @params, CultureInfo culture)
        {
        ...
        /// <inheriteddoc />
        protected override bool? OnConvertBack(Visibility? value, IList<string> @params, CultureInfo culture)
        {
